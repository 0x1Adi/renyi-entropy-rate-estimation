...
**Paper:** [arXiv:XXXX.XXXXX](https://arxiv.org/abs/XXXX.XXXXX) (submitted)

## Key Result

On 124 DNS tunnel pcaps, Rényi entropy rate outperforms Shannon entropy by 3.5× for tool classification (ARI = 0.720 vs 0.204), validated through a controlled 9-method ablation with debiasing controls.
...
Requires the [GraphTunnel dataset](https://github.com/GuanhuaGao/GraphTunnel):
...
The spectral decomposition F₂(k) = π^T M₂^k π (where M₂ is the Hadamard square of the transition matrix) guarantees log F₂(k) is asymptotically linear, with slope equal to log λ₁(M₂).
